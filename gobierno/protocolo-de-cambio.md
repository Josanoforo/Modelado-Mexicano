# Protocolo de cambio (interno)

Movido desde `CONTRIBUTING.md` por el acto GEN2-FRONT-3-PORTADA-1 (26/sep/2026), sin cambio de contenido: `CONTRIBUTING.md` pasa a ser la página para personas externas. Rige el desarrollo interno, que entra por `/acto`.
