...
- **Procedencia.** SHA `aed9ace3` · fecha del commit `2026-09-25` · ¿árbol == origin/main? `True`.
...
- **Gobernanza operativa.** ADR máximo del espacio numérico CERRADO `593` · FP máximo del mismo espacio `409` · ids con raíz de acto (época vigente) `{'ADR': 115, 'FP': 142, 'NC': 374}` · FP abiertas: FP-260921-GEN2-CORPUS-INTEGRIDAD-Y-RESPALDO-1-3d56-01, FP-260923-GEN2-TRAMITE-FIRMAS-12-c3fa-05, FP-260923-GEN2-FRONT-1-4296-01, FP-260924-GEN2-ASTRA5-U5-ADQUISICION-1-43d6-01, FP-260925-GEN2-RELEVO-CONSUMIDORES-2-e760-01, FP-260925-GEN2-RELEVO-CONSUMIDORES-2-e760-02, FP-260925-GEN2-RELEVO-CONSUMIDORES-2-e760-03, FP-260925-GEN2-CATALOGO-V1-1-1-afe1-01 · encargos archivados `755` (consumidos `677`) · instrucciones vigentes `v2.16` · cola de encargos (solo estados != CONSUMIDO; consumidos `61`):
