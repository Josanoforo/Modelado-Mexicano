# ENIGH2020-INTENSIDAD-REMESAS · especificación humana, generalización por ola v1.0
...
`CALC-ENIGH-0001`), sino el valor YA SELLADO de la ola 2020 en
`CALC-B-0001/resultados.json` (`RESULT-B-ENIGH-2020-P = 0.04377543852935772`, sobre
n=89006 hogares) — la misma serie `remesas>0` que el propio encargo cita
...
Ver `CALC-ENIGH2020-PERFIL-ESTRUCTURAL-0001/spec.md §2` (mismo hallazgo,
...
`RESULT-ENIGH20-REMINT-` en vez de `RESULT-ENIGH22-REMINT-`.
