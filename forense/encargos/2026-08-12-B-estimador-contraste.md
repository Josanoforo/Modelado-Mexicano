...
- **SHA de redacción:** `bfc0037` (merge de #170) · **Entorno asignado:** NUBE. **NO** la caja local Ubuntu CC — ahí corre E4b, y este acto no toca microdato ni `data/raw`. · **Estado:** VIVO
