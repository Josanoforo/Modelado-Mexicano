...
CALC_ID = "CALC-ENADID2023-UNION-SEXO-EDAD-0004"
...
STD_COLUMNS = ["tipo", "sexo", "edad", "n_denominador", "masa_denominador",
               "n_numerador", "masa_numerador", "punto", "ee", "ic95_lo", "ic95_hi", "gl",
...
def medir(inputs: dict, contrato: dict) -> dict:
    ...
    return {
        "RESULT-ENADID-USE4-P1-TABLA-SHA256": _sha(outputs["distribucion.csv"]),
        "RESULT-ENADID-USE4-P2-TABLA-SHA256": _sha(outputs["union_condicional.csv"]),
        "RESULT-ENADID-USE4-P3-TABLA-SHA256": _sha(outputs["estandarizacion.csv"]),
        "RESULT-ENADID-USE4-FLUJO-SHA256": _sha(outputs["flujo.csv"]),
        "RESULT-ENADID-USE4-AUDITORIA-SHA256": _sha(outputs["auditoria.json"]),
        "RESULT-ENADID-USE4-DIF-BRUTA-MH": std["diferencia_bruta"]["punto"],
        "RESULT-ENADID-USE4-DIF-ESTANDAR-MH": std["diferencia_estandarizada"]["punto"],
        "RESULT-ENADID-USE4-BRUTA-MENOS-ESTANDAR": std["bruta_menos_estandarizada"]["punto"],
        "RESULT-ENADID-USE4-REPLICAS": REPLICATES,
        "RESULT-ENADID-USE4-SEMILLA": SEED,
        "RESULT-ENADID-USE4-SALIDA": "forense/analisis/enadid2023-union-sexo-edad-cli-2",
    }
