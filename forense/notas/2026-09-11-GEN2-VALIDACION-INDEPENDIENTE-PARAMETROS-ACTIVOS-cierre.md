...
| consumo | `forense/prereg-duelo-v2/snapshot-M-gen2-explicito-v1_2.json`, SHA-256 `ca083554b8cd844b1a54a6147d37e26ff4096f15037e8cae6b4450f64ee763e6`; verificación exacta: 16 directas, 16 `EMITE`, 16 `PASA`, 16 identidades únicas |
| gobierno | `ADR-484`, anotación L0 y rótulo GEN2; ninguna obligación `NC` o firma existente correspondía a este objeto |
