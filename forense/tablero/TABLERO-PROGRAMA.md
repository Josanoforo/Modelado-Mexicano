...
- **Procedencia.** SHA `1b71f9a` · fecha del commit `2026-09-21` · ¿árbol == origin/main? `False`.
...
- **Corridas selladas que no cuentan todavía.** por `cuenta_gen2`: `NO` 10 · `NO-DERIVACION-CONTEXTUAL` 1 · `NO-SIN-FIRMA-DE-OBJETO` 1 · `PENDIENTE-DE-CASCADA-DIFERIDA` 2 · `PENDIENTE-DE-INTEGRACION-SERIAL` 2 · `PENDIENTE-DE-MESA` 4 · `SI` 117 (selladas total `137`) · `PENDIENTE-DE-MESA`:
...
- **Ramas presentes en origin.** **4 rama(s) presente(s) en origin (política de cero)**:
  - `acto/gen2-din-lote-enif2024-commit-1`: 13 delante / 19 detrás de main · último commit `2026-09-21`
  - `acto/gen2-l-desde-capturas-1`: 11 delante / 89 detrás de main · último commit `2026-09-21`
  - `acto/gen2-marcador-e-informe-1`: 10 delante / 8 detrás de main · último commit `2026-09-21`
  - `acto/gen2-v216`: 9 delante / 63 detrás de main · último commit `2026-09-21`
...
- **Gobernanza operativa.** ADR máximo del espacio numérico CERRADO `593` · FP máximo del mismo espacio `409` · ids con raíz de acto (época vigente) `{'ADR': 15, 'FP': 30, 'NC': 74}` · FP abiertas: FP-405, FP-408, FP-409, FP-260921-MOTOR-THETA-CONGELADA-1-e8fa-01, FP-260921-GEN2-ENUT-PISOS-Y-SERIE-1-308c-01, FP-260921-GEN2-CORPUS-INTEGRIDAD-Y-RESPALDO-1-3d56-01, FP-260921-GEN2-DIN-CREDITO-HISTORIA-1-ff56-01, FP-260921-GEN2-DIN-CREDITO-HISTORIA-1-ff56-02, FP-260921-GEN2-ENCIG-SERIE-Y-TENDENCIA-1-852f-01, FP-260921-GEN2-DIN-LOTE-ENIF2024-A-a98a-02, FP-260921-GEN2-ARBITRO-MARGINALES-1-ed7d-01, FP-260921-GEN2-ARBITRO-MARGINALES-1-ed7d-02 · encargos archivados `628` (consumidos `571`) · instrucciones vigentes `v2.16` · cola de encargos (solo estados != CONSUMIDO; consumidos `36`):
...
- **NC abiertas por razón (token A.14, prefijo exacto).** abiertas `207` · por token: `DECISIÓN-DE-MESA-PENDIENTE` 34 · `DIFERIDO-A` 25 · `FUERA-DE-PERÍMETRO` 40 · `NO-VERIFICABLE-AQUÍ` 7 · `PARO-ENTORNO` 4 · `PARO-PREMISA` 15 · `SUSTITUIDO-POR` 2 · prosa (sin token reconocible) `80`.
- **GEN2 (derivado de `corrida0 status`).** corridas selladas `141` / requeridas `87` · resultados sellados `23947` / activos `211` · pendientes `211` · dependencias numéricas legacy activas `146` · validación independiente `215` · diferencias materiales `0` · NC- abiertas `207` · replays LEGACY-GEN1 sellados `5` (no cuentan). El `0 / N` es la lectura correcta: el aparato se construyó antes que las corridas.
