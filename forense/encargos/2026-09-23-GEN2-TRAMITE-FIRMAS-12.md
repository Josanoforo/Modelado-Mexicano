...
## NO-CORRIDO / RESERVAS
- **P2 · Archivo de fuentes (informe de competencia y brief).** PARO-PREMISA — PARO f de §7 aplica textual: los tres adjuntos declarados en §3 (`INFORME-COMPETENCIA-2026-09-23.md` sha `acbaa795b67017c8…`, `BRIEF-DEEP-SEARCH-competencia-Mexico-2026-09-23.md`, `MISION-ASTRA-4-ADENDA-1.md`) no llegaron con la invocación de esta sesión — solo llegó este .md. Verificado (`ls /root/.claude/uploads/<sesión>/` → 1 archivo; `ls forense/encargos/fuentes/` sin los nombres declarados). Impacto: el informe de competencia y el brief siguen sin sha citable desde el repo; la adenda sigue sin archivar. Sucesor: `GEN2-TRAMITE-FIRMAS-13` (nombrado por §10) o el trámite que reciba los tres adjuntos con sha256 — mesa los re-adjunta. Fila: `NC-260923-GEN2-TRAMITE-FIRMAS-12-c3fa-01`.
- **P3 · Cierre de la NC de FIRMAS-11 (HOJA-DE-DECISIONES-2026-09-23.md).** PARO-PREMISA — mismo motivo: el adjunto (sha `0fc5b52b57e6b365…`) no llegó con esta sesión. Sigue abierta. Impacto: la hoja de decisiones del 23/sep tarde sigue sin archivarse con sha, aunque D1–D4 ya quedaron asentadas verbatim en `firmas-pendientes.tsv` por este acto. Sucesor: `GEN2-TRAMITE-FIRMAS-13` o el trámite que reciba el adjunto. Fila: `NC-260923-GEN2-TRAMITE-FIRMAS-12-c3fa-02`.
