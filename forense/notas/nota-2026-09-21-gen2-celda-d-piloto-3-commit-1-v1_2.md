...
3. **Colisión de números en vuelo:** `#941` (base de este acto) lleva `ADR-578`; `#943` (abierto) también declara `ADR-578` y `NC-0447`. Regla de la casa: renumera quien fusiona segundo. Este acto toma `ADR-584` (tras `#946`, que tomó `ADR-583`).
