...
- **Procedencia.** SHA `1746e1a0` · fecha del commit `2026-09-16` · ¿árbol == origin/main? `True`.
...
- **Gobernanza operativa.** ADR máximo `537` · FP máximo `384` · FP abiertas: FP-379, FP-383 · encargos archivados `536` (consumidos `493`) · cola de encargos:
