...
- **Procedencia.** SHA `d868f464` · fecha del commit `2026-09-24` · ¿árbol == origin/main? `True`.
...
- **Corridas selladas que no cuentan todavía.** por `cuenta_gen2`: `False` 1 · `NO` 18 · `NO-DERIVACION-CONTEXTUAL` 1 · `NO-SIN-FIRMA-DE-OBJETO` 1 · `PENDIENTE-DE-CASCADA-DIFERIDA` 2 · `PENDIENTE-DE-INTEGRACION-SERIAL` 2 · `PENDIENTE-DE-MESA` 15 · `SI` 223 (selladas total `263`) · `PENDIENTE-DE-MESA`:
...
- **Gobernanza operativa.** ADR máximo del espacio numérico CERRADO `593` · FP máximo del mismo espacio `409` · ids con raíz de acto (época vigente) `{'ADR': 109, 'FP': 135, 'NC': 338}` · FP abiertas: FP-260921-GEN2-CORPUS-INTEGRIDAD-Y-RESPALDO-1-3d56-01, FP-260923-GEN2-TRAMITE-FIRMAS-12-c3fa-05, FP-260923-GEN2-FRONT-1-4296-01, FP-260924-GEN2-ADOPCION-BLOQUE-Y-PINES-2-e0db-03, FP-260924-GEN2-REPLAY-NO-VERIFICADOS-1-822a-01, FP-260924-ASTRA5-U0-MAPA-DOMINIOS-63db-01, FP-260924-GEN2-ENCIG-PISOS-GEN2-1-19a3-02, FP-260924-GEN2-CATALOGO-CONTRATO-Y-TEST-1-23e3-01, FP-260924-GEN2-ASTRA5-U5-ADQUISICION-1-43d6-01, FP-260924-GEN2-ASTRA5-U5-ADQUISICION-1-43d6-02, FP-260924-GEN2-ASTRA5-U5-ADQUISICION-1-43d6-03, FP-260924-GEN2-ASTRA5-U5-ADQUISICION-1-43d6-04, FP-260924-GEN2-INFORME-V1-3-1-b1aa-01, FP-260924-GEN2-RELEVO-MOTOR-34-1-a157-01, FP-260924-GEN2-RELEVO-MOTOR-34-1-a157-02, FP-260924-GEN2-RELEVO-MOTOR-34-1-a157-03, FP-260924-GEN2-CLASE-AMAI-1-e773-01, FP-260924-GEN2-CLASE-AMAI-1-e773-02 · encargos archivados `747` (consumidos `669`) · instrucciones vigentes `v2.16` · cola de encargos (solo estados != CONSUMIDO; consumidos `61`):
...
- **NC abiertas por razón (token A.14, prefijo exacto).** abiertas `344` · por token: `DECISIÓN-DE-MESA-PENDIENTE` 49 · `DIFERIDO-A` 72 · `FUERA-DE-PERÍMETRO` 57 · `NO-VERIFICABLE-AQUÍ` 17 · `PARO-ENTORNO` 2 · `PARO-PREMISA` 34 · `SUSTITUIDO-POR` 6 · prosa (sin token reconocible) `107`.
- **GEN2 (derivado de `corrida0 status`, valores EN ÁRBOL; vistas del árbol distintas de HEAD: `data/corrida0/corridas.tsv, data/corrida0/resultados.tsv, data/corrida0/pines-sellados-resueltos.tsv, data/corrida0/usos.tsv, data/corrida0/marcador-segmento.tsv`).** adoptados activos `128` · pendientes de adopción `10` · corridas selladas `263` / requeridas `87` · resultados sellados `73077` / activos `211` · pendientes `211` · dependencias numéricas legacy activas `137` · validación independiente `215` · diferencias materiales `0` · NC- abiertas `344` · replays LEGACY-GEN1 sellados `5` (no cuentan). El `0 / N` es la lectura correcta: el aparato se construyó antes que las corridas.
