...
- **Procedencia.** SHA `0b62392` · fecha del commit `2026-09-21` · ¿árbol == origin/main? `False`.
...
- **Corridas selladas que no cuentan todavía.** por `cuenta_gen2`: `NO` 10 · `NO-DERIVACION-CONTEXTUAL` 1 · `NO-SIN-FIRMA-DE-OBJETO` 1 · `PENDIENTE-DE-CASCADA-DIFERIDA` 2 · `PENDIENTE-DE-INTEGRACION-SERIAL` 2 · `PENDIENTE-DE-MESA` 4 · `SI` 110 (selladas total `130`) · `PENDIENTE-DE-MESA`:
...
- **Ramas presentes en origin.** **9 rama(s) presente(s) en origin (política de cero)**:
  - `acto/gen2-adquiere-envipe2026-enigh2024-1`: 4 delante / 26 detrás de main · último commit `2026-09-21`
  - `acto/gen2-corpus-integridad-y-respaldo-1`: 5 delante / 76 detrás de main · último commit `2026-09-21`
  - `acto/gen2-din-credito-historia-1`: 21 delante / 0 detrás de main · último commit `2026-09-21`
  - `acto/gen2-din-lote-enif2024-commit-1`: 0 delante / 18 detrás de main · último commit `2026-09-21`
  - `acto/gen2-enigh2024-reserva-y-diseno-1`: 5 delante / 26 detrás de main · último commit `2026-09-21`
  - `acto/gen2-enut-pisos-y-serie-1`: 13 delante / 26 detrás de main · último commit `2026-09-21`
  - `acto/gen2-l-desde-capturas-1`: 11 delante / 26 detrás de main · último commit `2026-09-21`
  - `acto/gen2-marcador-e-informe-1`: 8 delante / 26 detrás de main · último commit `2026-09-21`
  - `acto/gen2-v216`: 1 delante / 0 detrás de main · último commit `2026-09-21`
...
- **Gobernanza operativa.** ADR máximo del espacio numérico CERRADO `593` · FP máximo del mismo espacio `409` · ids con raíz de acto (época vigente) `{'ADR': 9, 'FP': 24, 'NC': 60}` · FP abiertas: FP-405, FP-408, FP-409, FP-260921-MOTOR-THETA-CONGELADA-1-e8fa-01, FP-260921-GEN2-ENCIG-SERIE-Y-TENDENCIA-1-852f-01, FP-260921-GEN2-DIN-LOTE-ENIF2024-A-a98a-02, FP-260921-GEN2-ARBITRO-MARGINALES-1-ed7d-01, FP-260921-GEN2-ARBITRO-MARGINALES-1-ed7d-02 · encargos archivados `623` (consumidos `566`) · instrucciones vigentes `v2.16` · cola de encargos (solo estados != CONSUMIDO; consumidos `36`):
...
- **NC abiertas por razón (token A.14, prefijo exacto).** abiertas `197` · por token: `DECISIÓN-DE-MESA-PENDIENTE` 29 · `DIFERIDO-A` 23 · `FUERA-DE-PERÍMETRO` 40 · `NO-VERIFICABLE-AQUÍ` 7 · `PARO-ENTORNO` 3 · `PARO-PREMISA` 15 · `SUSTITUIDO-POR` 1 · prosa (sin token reconocible) `79`.
- **GEN2 (derivado de `corrida0 status`).** corridas selladas `134` / requeridas `87` · resultados sellados `18465` / activos `211` · pendientes `211` · dependencias numéricas legacy activas `146` · validación independiente `215` · diferencias materiales `0` · NC- abiertas `197` · replays LEGACY-GEN1 sellados `5` (no cuentan). El `0 / N` es la lectura correcta: el aparato se construyó antes que las corridas.
