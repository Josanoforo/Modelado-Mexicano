...
def genera():
    ...
    with OUT.open("w", newline="", encoding="utf-8") as f:
        ...
        for (inst, conducta), v in sorted(grupos.items()):
            ...
            if (inst, conducta) == ("ENIF", "informal_cualquiera"):
                state = "MEDIDO-SOLO-DOMINIO-18A70"
            if pseudo:
            ...
            nota = ("El código U1 es una identidad de celda/interacción, no una conducta simple; "
                    ...
                    if pseudo else "La serie U5 18–70 no sustituye el universo U1 18+; falta piso general."
                    if state == "MEDIDO-SOLO-DOMINIO-18A70" else
