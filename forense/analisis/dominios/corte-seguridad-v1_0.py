...
ROW = dict(
    ...
    limite_inferencial="La no denuncia/carpeta es respuesta y trámite por incidente; no identifica tolerancia cultural ni cálculo racional individual. No equiparar 93.2% a proporción de personas ni a delitos denunciados sin investigación efectiva.",
    ...
    estado_verificacion="CERRADA", dictamen="MEDIBLE-CON-ADQUISICIÓN",
    dictamen_razon="Microdato, módulo y FD 2025 tienen ids en manifiesto y SHA físico coincidente; falta registrar exclusivamente diseño muestral oficial ENVIPE 2025. La pregunta primaria se verificó, pero el agregado cifra negra requiere reglas por tipo y factor incidentes.",
    ...
    propietario="ASTRA5-U3", siguiente_operacion="Registrar solo diseño ENVIPE 2025 889463926689.pdf; fijar denominador de incidentes, filtro de delitos, denuncia/carpeta y factor antes de cualquier cálculo.", prioridad="3",
)
