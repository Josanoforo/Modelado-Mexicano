...
| corrupción general | D08 / lote 02 | ENCUCI 2020 `AP5_17/AP5_18`, `CALC-R-TRA-M-02-v3`; UNAM-IIJ corrupción | ENCUCI da `0.1260` entre personas con contacto; UNAM cubre cuatro trámites | falta adjudicar el denominador general. ENCIG `B-COVERAGE=0.200895` es condicional entre declarantes; no abrir otra búsqueda hasta que `ENCARGO-E04` inscriba la demanda exacta |
