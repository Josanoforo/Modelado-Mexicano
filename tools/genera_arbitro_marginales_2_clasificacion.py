...
CLASIFICACION = {
    ...
    "familia.corresidencia.adulto_familiar": ("RE-MEDIDA", "EDER 2017",
        "P2 de este acto: payload COINCIDE (eder_2017_eder2017_bases_csv), COMMIT-1 nuevo"),
    "tramite.mordida.discrecional": ("RE-MEDIDA", "ENCUCI 2020",
        "P2 de este acto: payload COINCIDE (encuci2020_bd_dbf), COMMIT-1 nuevo"),
    ...
    "familia.seguro.volatilidad_ausencia_estado": ("RE-MEDIDA", "ENIGH 2022",
        "P2 de este acto: payload COINCIDE (enigh2022_nc_csv), COMMIT-1 nuevo"),
    "dinero.planeacion.formal_estable": ("RE-MEDIDA", "ENFIH 2019",
        "P2 de este acto: payload COINCIDE (enfih2019_bd_csv_zip), COMMIT-1 nuevo"),
    ...
    "civico.protesta.agravio_urbano_encuci2020": ("RE-MEDIDA", "ENCUCI 2020",
        "situacion GEN1 = CARGADA-A-MOTOR; ver nota para el CALC GEN2 exacto que ya la mide"),
    ...
    "salud.atencion.grave_ensanut2024": ("RE-MEDIDA", "ENSANUT 2024",
        "candidato data/corrida0/CALC-ENSANUT-0001; ver nota para confirmar coincidencia exacta de definicion"),
    "salud.vacunacion.disponible_ensanut2024": ("RE-MEDIDA", "ENSANUT 2024",
        "situacion GEN1 = CARGADA-A-MOTOR; candidato data/corrida0/CALC-ENSANUT-0001"),
    "salud.atencion.grave_ennvih2002": ("RE-MEDIDA", "ENNViH 2002 (ola 1)",
        "payload COINCIDE (ennvih1_2002_hogar_dta); situacion GEN1 = NO-ESTIMABLE-EN-v1_1 -- candidato a RE-MEDIDA como NO-CONSTRUIBLE-con-texto, ver nota"),
    ...
    "dinero.credito.atraso_y_dano_por_producto_banxico": ("RE-MEDIDA", "Banxico (administrativo, no encuesta)",
        "candidato data/corrida0/CALC-BANXICO-PRODUCTO-DANO-0001; ver nota para confirmar coincidencia exacta"),
    "trabajo.prestaciones.valoracion_seguridad_social_motral": ("RE-MEDIDA", "MOTRAL 2015 (experimento)",
        "candidato data/corrida0/CALC-MOTRAL2015-VALORACION-SS-0001; ver nota para confirmar coincidencia exacta"),
