...
ROW = dict(
    ...
    documento_id_hash_pagina="Cuestionario público CENDUTIH2024.pdf|95514c5fe0a000bfaf29062a9cf9225ec64674dbb83df6a44a3dceda13187800|p.8;FD endutih2024_fd_xlsx|ecdf95924b0b31e2593fdfabe69cf88ecbc5c90a40b3fa3caa9f8427147a96de|tic_2024_usuarios filas 101-110;diseño público RNM-1102/34413|97ee8088cd12d3112e1d0f3bf4bafb1bb11a9175b93b3dfb9bab61e08833b612",
    ...
    dictamen_razon="Datos y FD en manifiesto y hash físico coincidente; faltan únicamente las entradas documentales del cuestionario y diseño muestral 2024.",
    ...
    gen2_existente="Reusar mediciones de canal digital ENIF/ENCIG si aplican; sin RESULT nuevo.",
    propietario="ASTRA5-U4",
    siguiente_operacion="Registrar exclusivamente CENDUTIH2024.pdf y diseño RNM-1102/34413; verificar reserva específica; preregistrar denominadores antes de abrir microdato.",
    prioridad="2",
)
