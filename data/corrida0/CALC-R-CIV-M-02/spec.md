...
**Celda:** `CIV-M-02` — ENVIPE 2013, **delitos de 2012**.
**Releva:** `CORR-0028` → `RES-0098`, el árbitro `R` de esta celda del marco `M`.
Consumidor natural: `forense/prereg-duelo-v2/marco-M-sorteado-v1_3.tsv:CIV-M-02:R`.
...
| campo | valor |
|---|---|
| `id` de manifiesto | **`envipe_2013_bd_envipe13_dbf`** |
| miembro del ZIP | `tmod_vic.dbf` — literal, nunca por plantilla |
| filas (cabecera DBF) | 47,117 |
| descriptor citado | `FD_ENVIPE13.xlsx, hoja TMod_Vic` — `BP1_23` fila 292, `BPCOD` fila 30, diseño filas 626 (FAC_DEL), 632 (EST), 633 (UPM) |
...
No abre `tools/arbitra.py` ni `corridas-R/CIV-M-02.json`: el control positivo es script
