"""Monto e intensidad contable de remesas entre hogares receptores, ENIGH 2018.

Generalizacion, byte-identica en 2022, de
CALC-ENIGH2022-INTENSIDAD-REMESAS-0001/medidor.py (ACTO
GEN2-ENIGH2024-SERIE-Y-COMMIT-1, P1). El control de prevalencia contra el
padre usa el valor ya sellado de la ola 2018 en CALC-B-0001/resultados.json
(serie remesas>0 de RES-0165..0170, 5 olas), en vez del valor 2022 que
CALC-ENIGH2022-INTENSIDAD-REMESAS-0001 usaba.
...
P = "RESULT-ENIGH18-REMINT-"
MIEMBRO = (
    "conjunto_de_datos_concentradohogar_enigh_2018_ns/conjunto_de_datos/conjunto_de_datos_concentradohogar_enigh_2018_ns.csv"
)
COLUMNAS = [
