# ENIGH2018-PERFIL-ESTRUCTURAL · especificación humana, generalización por ola v1.0
...
en `poblacion.csv` de la ola 2018, las columnas `factor`, `est_dis` y `upm`
**no existen** (verificado contra el header real del zip: ausentes en
2018/2018/2020, presentes en 2022 y 2024). En 2022 se comprobó — muestreando
...
en adelante, sin cambiar el diseño. Para 2018, este medidor toma esas tres
...
propio de la ola 2018 (`enigh2018_descripcion_base_pdf` NO EXISTE en
...
2018. Si un acto futuro trae el descriptor de 2018, esta asunción se
...
`RESULT-ENIGH18-PERFIL-` (2 dígitos de año, misma convención que el
...
adicional de que 2018 tampoco tiene descriptor propio en el corpus para
...
descriptiva de personas en hogares de México, ENIGH 2018. No identifica
