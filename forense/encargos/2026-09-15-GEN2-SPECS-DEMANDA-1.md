...
**Este encargo NO queda agotado.** Es multi-día por diseño del lanzamiento: la **tanda 1** congeló cuatro specs (`CORR-0011`, `CORR-0012`, `CORR-0013`, `CORR-0014`) y entregó el mapa completo de las 19; la **tanda 2** (`NC-0193`) tiene cuatro más construibles y sin bloqueo material — `CORR-0017`, `CORR-0016` y los residuos de `CORR-0009` y `CORR-0007`.
