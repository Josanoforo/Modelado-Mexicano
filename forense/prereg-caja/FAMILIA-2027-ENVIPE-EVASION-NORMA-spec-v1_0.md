# FAMILIA-2027-ENVIPE-EVASION-NORMA · spec humana condicional v1.0
...
- Estimando único: evasión de norma bajo la codificación A vigente. Unidad de observación: **persona**; escala del punto **proporción [0,1]**. No se agregan otros estimandos tras observar R.
- Piso congelado en este borrador: `RESULT-EVASIONNORMA-A-P-EVADE` de `CALC-EVASION-NORMA-0001-v1_1` (ola 2025); SHA-256 de `sello.json`: `8076d9ff1e18ab1fe6ac7168600810580cabe99c1df9373ee21c8b40e9d2abe8`. Su valor se lee del RESULT, no se transcribe como parámetro de producto. Si una ola intermedia cambia la identidad, esta spec se declara NO-ELEGIBLE; no se sustituye el piso a posteriori.
