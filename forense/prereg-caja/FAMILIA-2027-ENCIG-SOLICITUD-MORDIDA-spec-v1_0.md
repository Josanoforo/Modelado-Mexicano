# FAMILIA-2027-ENCIG-SOLICITUD-MORDIDA · spec humana condicional v1.0
...
- Estimando único: solicitud de mordida en el universo A de ENCIG MOR. Unidad de observación: **persona**; escala del punto **proporción [0,1]**. No se agregan otros estimandos tras observar R.
- Piso congelado en este borrador: `RESULT-ENCIG-MOR-A-P-SOL1` de `CALC-ENCIG-0001` (ola 2025); SHA-256 de `sello.json`: `9db7e8f292dc4acd43ee1107b00fe7e1c6097d6abaa3b8c78444107b6cbf58d7`. Su valor se lee del RESULT, no se transcribe como parámetro de producto. Si una ola intermedia cambia la identidad, esta spec se declara NO-ELEGIBLE; no se sustituye el piso a posteriori.
