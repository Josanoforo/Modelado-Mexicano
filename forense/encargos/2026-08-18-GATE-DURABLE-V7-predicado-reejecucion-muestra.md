...
**Estado:** CONSUMIDO — ACTO GATE-DURABLE-V7, rama `gate-durable-v7`, 18/ago/2026. PR sellado en el commit de cierre. Sella `ADR-100`. El `PARO` del ARRANQUE 1 que esta cabecera declaraba se levantó cuando `PR #255` fusionó (`ae25137`); de ahí en adelante el encargo se ejecutó completo: `COMMIT 0` a `COMMIT 4`.
