# ENIGH2018-INTENSIDAD-REMESAS · especificación humana, generalización por ola v1.0
...
`CALC-ENIGH-0001`), sino el valor YA SELLADO de la ola 2018 en
`CALC-B-0001/resultados.json` (`RESULT-B-ENIGH-2018-P = 0.04728548395278385`, sobre
n=74647 hogares) — la misma serie `remesas>0` que el propio encargo cita
...
Ver `CALC-ENIGH2018-PERFIL-ESTRUCTURAL-0001/spec.md §2` (mismo hallazgo,
...
`RESULT-ENIGH18-REMINT-` en vez de `RESULT-ENIGH22-REMINT-`.
