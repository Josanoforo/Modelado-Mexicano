...
- Cascada: `ADR-505` (renumerado de `ADR-504`; `NC-0189` renumerada de `NC-0186`: `GEN2-ADOPCION-VENTANILLA-2`, PR #762, fusionó primero), L0 y tres contadores reconciliados (`cierre_acto.py --aplica`), rótulo censado, hallazgo, `NC-0189` con `#764`, suite `--baseline` VERDE (3 FAIL preexistentes iguales al baseline).
