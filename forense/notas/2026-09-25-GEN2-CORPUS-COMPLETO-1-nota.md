...
`tabla-final-v1_0.tsv` (`tabla_final_corpus.py --verifica` COINCIDE): 146 programas; 131 con olas adquiridas por este acto; 19 con ola reservada; 8 con NO OBTENIDO o NO-APLICA. NO OBTENIDO POR ESTE AGENTE EN 1 INTENTOS, con receta en la tabla: Latinobarómetro (login), LAPOP (cuenta Vanderbilt), WVS y EVS (formulario de términos), EMOVI 2011/2017/2023 (formulario CEEY), Pew Religion in Latin America 2014 (login y reto anti-bot). NO-APLICA: Banxico y CNBV no publican microdato individual. Ya en corpus por otros actos: ENSANUT (U5), Latinobarómetro 2023 (U5), WVS México y LAPOP (cola previa).
