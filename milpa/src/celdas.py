...
CORTES_C1 = Cortes(
    por_eje={
        ...
        # ENMIENDA FECHADA 17/sep/2026 · ACTO GEN2-CORTE-EDAD-1 · ADR-533:
        #   resuelto por ADR-533; FP-53 era otro objeto. FP-53 quedó FIRMADA el
        ...
        #   sellado autorizada bajo ADR-100(2) con ADR-533 como fuente.
    ...
    firma_m2=(
        ...
        " || ADR-533 · ACTO GEN2-CORTE-EDAD-1 · firma D4 de mesa 16/sep/2026"
