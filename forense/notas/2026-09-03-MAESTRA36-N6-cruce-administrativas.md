...
Append-only: **ninguna línea de arriba se edita ni se borra**. El sitio
afectado en esta nota es `:38` («el curador **no liga ninguna fuente a
ninguna regla de salud**»), que la mitad `A.13-b` de abajo acota.
