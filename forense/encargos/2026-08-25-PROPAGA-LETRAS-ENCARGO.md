...
Encargo PROPAGA-LETRAS — ejecuta las tres letras de mesa (R2.2·R8.2·R10.2) · archiva B y D, ordena el censo · Hito D +2

SHA de redacción: 9c25f28. Dirección, 25/ago/2026. ENTORNO: NUBE (cloud_default). No UBUNTU, no doble. FIRMAS DE MESA, verbatim del chat de dirección (25/ago), embebidas aquí — no hay ranura nueva salvo la confirmación de 5 segundos de R8.2: mesa escribió: «R2.2: a - R8.2: a - R10.2: a», donde las opciones (a) presentadas fueron: R2.2 = censo previo molde-R2.1 · R8.2 = «verificación puntual; si confirma apps-sin-tasa → archívese B» · R10.2 = «D tras el cruce». El cruce (#363) ya corrió y la verificación de R8.2 la corrió dirección (anexo abajo).

RANURA (5 seg, por el matiz del anexo): CONFIRMO R8.2: fila B con la reserva escrita. — o Cámbiese a D. Ausente → se ejecuta todo menos el archivo de R8.2, que queda PROPUESTO.
