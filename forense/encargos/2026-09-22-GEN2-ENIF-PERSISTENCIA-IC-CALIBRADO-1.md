...
- **qué:** «PREGUNTAS A MESA: si 2015 no es comparable por texto en la mayoría de celdas, ¿calibrar solo con 2018→2021 (recomendado, declarado) o esperar?» · **por qué:** DECISIÓN-DE-MESA-PENDIENTE: 2015 no es comparable en 20/32 celdas; COMMIT-1 congeló la rama recomendada (2015 sólo DESCRIPTIVO) · **impacto:** τ² descansa en un solo cambio trienal; ninguna cobertura cambia si mesa ratifica · **sucesor:** `FP-260922-GEN2-ENIF-PERSISTENCIA-IC-CALIBRADO-1-2868-01` (pregunta aneja) — `NC-260922-GEN2-ENIF-PERSISTENCIA-IC-CALIBRADO-1-2868-01`
- **qué:** «P3: FP nueva para mesa: adoptar ENIF con IC calibrado si cobertura ≥ X» · **por qué:** DECISIÓN-DE-MESA-PENDIENTE: el acto la abre y no la firma (encargo §2); lectura mecánica de X = 0.80: CUMPLE · **impacto:** las 32 celdas ENIF siguen DIFERIDA; `celdas_validadas` no se mueve · **sucesor:** `FP-260922-GEN2-ENIF-PERSISTENCIA-IC-CALIBRADO-1-2868-01` → `GEN2-MARGINALES-ADOPCION-2` — `NC-…-2868-02`
- **qué:** fila propia de `corridas.tsv` (registro, E.7) · **por qué:** NO-VERIFICABLE-AQUÍ: `envuelto_legacy`/`origen_numerico` salen INDETERMINADO (inputs METADATO que citan CALC por id); la spec congelada no se edita · **impacto:** ninguno en cifras; `cuenta_gen2 = SI` por etiqueta · **sucesor:** mesa -- fila caso por caso en `decisiones.tsv` si hace falta — `NC-…-2868-03`
