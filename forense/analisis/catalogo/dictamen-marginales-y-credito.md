...
**Estado de #1058 tras #1086.** El PR se fusionó el 23/sep/2026. Sus nueve archivos de celda-D están en main. La decisión de tubería P3 quedó dada por `ADR-260923-GEN2-CONTADORES-CONSUMO-1-988c-01` y `NC-260923-GEN2-DIN-CREDITO-CELDAS-D-2-f6a3-02` está CERRADA: siete celdas-D PUNTUADA suman 111 celdas al contador; k4a y k4b siguen SKIP. `celdas_validadas` pasó de 92 a 219 en total, incluidos otros 16 de ENCIG 2025. Esta validación es una métrica de evaluación, no una firma de adopción ni prueba de consumo de los RESULT de crédito por el modelo.

**Verificación:** la lectura de `usos.tsv` y de las decisiones distingue los RESULT GEN2 activos, las firmas pendientes de consumo y los vetos. `python3 tools/celdas_validadas.py --linea` da 219 celdas validadas tras #1086. Son estados operativos derivados, no mediciones de conducta; el marcador aún no se republicó al canal por la reserva de origen numérico de dos CALC de GOB-DIGITAL-EXE (`FP-260923-GEN2-CONTADORES-CONSUMO-1-988c-01`).
