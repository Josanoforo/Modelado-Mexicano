...
La fracción **medida dentro de cada serie corrida** se deriva del canon: todas las filas esperadas de sus tres pisos iniciales, ocho olas históricas y bloque de portafolio están presentes, incluidas las que R2 pudiera suprimir. Esta fracción no es cobertura del catálogo general. En el lote actual, `python3 tools/astra/region/publica.py` declara 290 filas y estados; los denominadores de conductas pendientes no se convierten en ceros.
