...
> | **CLASE** | Corrección de vocabulario, ordenada por `ADR-71(d)` (12/ago/2026, `MESA-cuatro-decisiones-3_1-a-3_4.md` §3.4): "el enum `fuerza` del contrato celda-D se corrige antes de E0". Aplica sobre el contrato ya adoptado por ADR-68 — no reabre ninguna otra decisión de v0.3, no reabre M1, no ejecuta celda alguna |
