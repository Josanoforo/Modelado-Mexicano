...
- **Procedencia.** SHA `b881ee69` · fecha del commit `2026-09-16` · ¿árbol == origin/main? `True`.
...
- **Gobernanza operativa.** ADR máximo `530` · FP máximo `376` · FP abiertas: FP-376 · encargos archivados `517` (consumidos `485`) · cola de encargos:
