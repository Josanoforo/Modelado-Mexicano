# `CALC-R-TRA-M-03-v3` — sucesor técnico de replay del árbitro R

 **Corrección adversarial PR #680:** sucede al sello `-v2` sin mutarlo. FP-370 conserva su alcance y no se extiende a este identificador técnico. **Celda:** `TRA-M-03`.
...
`codificacion-R-v1_2.tsv`, sucesora registral de v1.1 que conserva el estimando y explicita reservas: payload `encig_2013_encig13_base_datos_dbf`,
...
Este sucesor técnico no añade una medición: hereda el conteo único de la cadena desde `CALC-R-TRA-M-03-v2`, cuyo objeto firmado es la medición R de `TRA-M-03`.
