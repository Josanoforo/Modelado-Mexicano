...
def medir(inputs, contrato):
    ...
    if not all(name in data.columns for name, _, _ in QUESTIONS.values()):
        raise ValueError("faltan reactivos congelados ENCUP")
    table = {key: summarize(data[name], valid, selected)
