...
SHA de redacción: derivar al lanzar (escrito el 18/ago/2026 por `ACTO MESA-19AGO`). Entorno asignado: **NUBE** (repo-only). Estado: **CONSUMIDO** — `ADR-115`, `PR #283`, 19/ago/2026. Origen: firma de mesa D-3 de `MESA-19AGO`, `ADR-110(a)`/`ADR-111(c)` (renumerado al fusionar), fila `FP-56`.
