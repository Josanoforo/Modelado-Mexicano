...
- **qué:** «si HEREDADO-DE-LEGACY > 2 celdas, NC con `DIFERIDO-A: GEN2-PISOS-GEN2-2`» — relevo de los 20 C2 HEREDADO-DE-LEGACY de ENIF (`DIN.ahorro_solo_informal.enif2024.localidad_x_edad`, 8) y ENVIPE (`TRA.evade_norma.envipe2025.escolaridad_x_dominio`, 12) · **por qué:** DIFERIDO-A:GEN2-PISOS-GEN2-2 -- fuera del perímetro §9; respuesta de mesa 24/sep «NC a PISOS-GEN2-2» · **impacto:** 20 celdas del marcador siguen consumiendo un piso con marginales de `milpa/`; T-REPRO no lo ve porque el resolvedor las marca NUEVO · **sucesor:** GEN2-PISOS-GEN2-2 (consumo mientras tanto: `FP-260924-GEN2-ENCIG-PISOS-GEN2-1-19a3-02`)
- **qué:** el resolvedor de linaje (`tools/corrida0.py::_propaga_envuelto`) no ve números tecleados en `parametros` · **por qué:** DIFERIDO-A:GEN2-PISOS-GEN2-2 -- `tools/corrida0.py` es motor, fuera de §9 («no toca el motor», §10) · **impacto:** `origen_numerico` puede dar NUEVO a un número copiado de `milpa/` (medido: DIN y TRA) · **sucesor:** GEN2-PISOS-GEN2-2
- **qué:** «P2 · piso ENCIG 2023 medido desde microdato» y el id `CALC-ENCIG2023-PISOS-GOBDIGITAL-0001` del «hecho» · **por qué:** PARO-PREMISA -- el piso C2 del duelo es la composición de marginales **2025** (spec del -0001 §3; v2.16 §4); mesa respondió «Marginales 2025» y se midió `CALC-ENCIG2025-PISOS-GOBDIGITAL-0001` · **impacto:** ninguno sobre contadores; el nombre del CALC y de su spec difiere del «hecho» y del perímetro §9 · **sucesor:** GEN2-ENCIG-PISOS-GEN2-1 (cerrada en este acto)
- **qué:** reserva — C7 y C-ENCOGIDA del -0002 siguen construidos sobre el C2 legacy (emisiones selladas del -0001) · **por qué:** FUERA-DE-PERÍMETRO:GEN2-DUELO-ENCIG2025-CIERRE-1 -- son sus emisiones selladas (PARO b); re-emitirlas después de R las volvería retrospectivas · **impacto:** su base difiere del C2 NUEVO en ≤ 5.6e-7; ningún veredicto cambia (máx. Δ contra el -0001: 5.56e-5 pp) · **sucesor:** MISION-ASTRA-4 (familia de retadores de ENCIG 2027, sobre el piso NUEVO)
