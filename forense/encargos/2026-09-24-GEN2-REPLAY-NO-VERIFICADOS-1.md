...
Ejecutado por PR #1110 (rama `acto/gen2-replay-no-verificados-1`). Cerrado por PARO (f): los seis replays ya estaban asentados y vigentes en `origin/main` (PR #1004). Detalle en `forense/notas/2026-09-24-GEN2-REPLAY-NO-VERIFICADOS-1-cierre.md`; `ADR-260924-GEN2-REPLAY-NO-VERIFICADOS-1-822a-01`.
