...
Gobernado por forense/prereg-caja/LAPOP-PISOS-OLAS-spec-v1_0.md. El mismo
...
def medir(inputs, contrato):
    ...
    if dis.get("peso_diagnostico"):
        ...
        diag = {"variable": dis["peso_diagnostico"], "min": float(v.min()),
                "max": float(v.max()), "n_vacios": int(v.isna().sum())}
