...
> ⚠️ **Enmienda in situ a la fila OLA 4 de esta tabla (20/ago/2026, `SELLA-C`, `ADR-140`).** «7 umbrales por comando → mesa firma GO/NO-GO»: `VENCIDO EN ALCANCE` (`A.10`) — sustituido como criterio vigente por `ADV1-M6 v2` (`forense/adv-duelo/ADV1-M6-v2-2026-08-20.md`). Fila original intacta arriba.
