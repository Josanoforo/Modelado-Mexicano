...
**Encargo:** `forense/encargos/2026-09-17-GEN2-CELDA-D-CAREO-1.md` (archivado verbatim, A.3, sha256 `f582ad38232e547d706e2ee6020184f2ddcccdb13fdddbc3ffc58f0ea78404f3`).
...
| `forense/CAREO-ADV-DUELO-diseno-v2-2026-08-19.md:38` | la condición `INDECIDIBLE` verbatim vive ahí | **VERIFICADA** — `M3`: *"si ambos caen dentro del IC de R"* |
| `forense/CAREO-ADV-DUELO-diseno-v2-2026-08-19.md:34` | el grado `P0` va «fuera del marcador, a anexo de plomería» | **VERIFICADA** — `M1(ii)` |
| `forense/CAREO-ADV-DUELO-diseno-v2-2026-08-19.md:42` | el careo tiene consecuencia propia si ninguno vence a `b` | **VERIFICADA** — `M5` casilla (4) |
...
Astra (§3.16) y Opus (cierre de `P3`) llegan al mismo sitio por caminos distintos, y conviene dejarlo escrito porque es lo que mesa firmó como `M1`:
