...
PATH = Path(__file__).resolve().parents[1] / "data/corrida0/CALC-ENDIREH-PISOS-2021-PAREJA-FISICA-BC-0001/medidor.py"
...
def test_suppression_and_determinism():
    rows = [{"vida": i % 4 == 0, "desde_octubre_2020": i % 6 == 0,
             ...
             "pareja": "B1", "entidad": "01"} for i in range(120)]
    ...
    assert next(x for x in a if x["eje"] == "pareja" and x["categoria"] == "C1")["estado"] == "SUPRIMIDA"
