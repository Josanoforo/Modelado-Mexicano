...
**Contador vigente: `1` llaves ejercidas de `2` filas.** *(Movido 13/ago/2026, ACTO ADJ-4 — `R5.1-D2` firma `EJERCIDA_INDECISA`, primera llave que sale de `SELLADA_NO_EJERCIDA` desde que este registro abrió. Verificación en §5.)*
