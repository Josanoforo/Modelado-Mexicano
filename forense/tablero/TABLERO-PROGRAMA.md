...
- **Procedencia.** SHA `1b3d317` · fecha del commit `2026-09-19` · ¿árbol == origin/main? `False`.
...
- **Gobernanza operativa.** ADR máximo `544` · FP máximo `386` · FP abiertas: FP-386 · encargos archivados `545` (consumidos `501`) · cola de encargos:
...
- **GEN2 (derivado de `corrida0 status`).** corridas selladas `86` / requeridas `83` · resultados sellados `5014` / activos `208` · pendientes `208` · dependencias numéricas legacy activas `184` · validación independiente `215` · diferencias materiales `0` · NC- abiertas `102` · replays LEGACY-GEN1 sellados `5` (no cuentan). El `0 / N` es la lectura correcta: el aparato se construyó antes que las corridas.
