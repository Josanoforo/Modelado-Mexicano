...
- **Procedencia.** SHA `f5eab3b` · fecha del commit `2026-09-21` · ¿árbol == origin/main? `False`.
...
- **Ramas presentes en origin.** **6 rama(s) presente(s) en origin (política de cero)**:
  - `acto/gen2-celda-d-piloto-3-commit-2-3-v1_2`: 1 delante / 0 detrás de main · último commit `2026-09-21`
  - `claude/entorno-spu2y7`: 9 delante / 0 detrás de main · último commit `2026-09-21`
  - `claude/epic-cori-4aiuak`: 0 delante / 54 detrás de main · último commit `2026-09-21`
  - `claude/lucid-hypatia-j9m0xj`: 10 delante / 19 detrás de main · último commit `2026-09-21`
  - `claude/tramite-2026-09-21`: 1 delante / 0 detrás de main · último commit `2026-09-21`
  - `claude/untitled-session-anhykf`: 5 delante / 28 detrás de main · último commit `2026-09-21`
...
- **Gobernanza operativa.** ADR máximo `584` · FP máximo `260921` · FP abiertas: FP-405, FP-408, FP-409 · encargos archivados `599` (consumidos `545`) · instrucciones vigentes `v2.15` · cola de encargos (solo estados != CONSUMIDO; consumidos `36`):
