...
|---|---|---|---|
| `F-17` (crosswalk de ejes árbitro↔modelo, citado en el mismo mensaje que `F-18`) | `FUERA-DE-PERÍMETRO` — el objeto de este acto es la calibración de Θ (`NC-0239`), no el vocabulario de ejes (`NC-0240`/`NC-0226`); mezclar los dos perímetros en un solo acto viola A.10 | `NC-0240` sigue sin firma resuelta y con una discrepancia de numeración sin aclarar (ver `forense/encargos/2026-09-16-GEN2-FIRMAS-MESA-3.md`) | acto propio de crosswalk, después de que mesa aclare si `F-17` quería decir `NC-0240` |
