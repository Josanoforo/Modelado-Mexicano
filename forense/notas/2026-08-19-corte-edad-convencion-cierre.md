...
Cascada de ADR: candidato **114** al escribir contra `35c9c9f` (113 únicos, máximo 113, sin huecos). Si `origin/main` avanza antes de fusionar, se re-deriva al fusionar, mismo protocolo que once ADR previos de esta semana.
