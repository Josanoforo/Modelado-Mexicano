...
Ejecutado por PR [#973](https://github.com/Josanoforo/Modelado-Mexicano/pull/973), rama `acto/gen2-l-desde-capturas-1`. `CALC-L-DESDE-CAPTURAS-v1_0` sellado (`preflight VERDE`, `run`, `verify REPRODUCE`/`CONTEXTO=IDENTICO`); `ADR-260921-GEN2-L-DESDE-CAPTURAS-1-1d7c-01`; `tests/check.py --baseline --parallel` VERDE. No fusionado por este ejecutor — el merge es de mesa (D-10, paso 9).
