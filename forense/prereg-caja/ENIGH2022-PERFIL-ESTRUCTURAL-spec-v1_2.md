# ENIGH2022-PERFIL-ESTRUCTURAL · especificación humana sucesora v1.2

Sucesora de v1.1 / `CALC-ENIGH2022-PERFIL-ESTRUCTURAL-0002`, preservados
intactos en commit `12b9bc8`. El primer `run` de 0002 resolvió correctamente
la ruta, abrió el contenedor y se detuvo validando la cabecera, antes de
iterar respuestas: el BOM UTF-8 leído como Latin-1 apareció como
`ï»¿folioviv`. Esta v1.2 añade únicamente esa representación al normalizador
de BOM, además de actualizar `calc_id`, ruta y sucesión. Todo el contrato
estadístico y todos los RESULT permanecen idénticos.
