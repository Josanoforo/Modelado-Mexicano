...
Contadores que mueve este acto: «estimadores en catálogo con RESULT» ({{c:estimadores}} adopciones citadas por firma) y «dominios MEDIDOS» ({{c:dominios_medidos}}). No mueve `adoptados_activos`, `celdas_validadas` ni ningún contador del marcador: los lee.
