...
GEN = ROOT / "forense/analisis/catalogo/genera_catalogo_v1_1.py"
...
class CatalogoV11(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.rows = lee(TSV)
    ...
    def test_puntero_y_v1_0_intacto(self):
        self.assertIn("catalogo-del-mexicano-v1_1", (ROOT / "docs/catalogo.md").read_text())
