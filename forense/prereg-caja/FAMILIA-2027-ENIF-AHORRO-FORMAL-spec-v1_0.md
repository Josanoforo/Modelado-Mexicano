# FAMILIA-2027-ENIF-AHORRO-FORMAL · spec humana condicional v1.0
...
- Estimando único: acceso a ahorro formal entre personas en el denominador B de ENIF AHO. Unidad de observación: **persona**; escala del punto **proporción [0,1]**. No se agregan otros estimandos tras observar R.
- Piso congelado en este borrador: `RESULT-ENIF-AHO-B-P-FORMAL-P` de `CALC-ENIF-0001` (ola 2024); SHA-256 de `sello.json`: `0c90801873c91ac109219fbe3bf88632fc6aa8a6bcef637f9876398e95f76de6`. Su valor se lee del RESULT, no se transcribe como parámetro de producto. Si una ola intermedia cambia la identidad, esta spec se declara NO-ELEGIBLE; no se sustituye el piso a posteriori.
