...
- **Procedencia.** SHA `d522f3d` · fecha del commit `2026-09-08` · ¿árbol == origin/main? `False`.
...
- **Gobernanza operativa.** ADR máximo `403` · FP máximo `348` · FP abiertas: FP-342, FP-343, FP-347, FP-348 · encargos archivados `379` (consumidos `361`) · cola de encargos:
