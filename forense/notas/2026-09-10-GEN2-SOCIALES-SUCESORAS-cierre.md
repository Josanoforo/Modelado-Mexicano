...
`CALC-0001-v2` cuenta GEN2 por D14/FP-363 con objeto explícito. No se incorpora ninguna tasa al motor y ningún tier cambia. Entrega: PR #688. PR #687 fusionó primero con ADR-455; este acto quedó renumerado a ADR-456 al sincronizar `origin/main = c03463f`.
