RECUPERADO 15/sep/2026 — el encargo original fue rescatado por mesa de su conversación ChatGPT de origen y archivado, verbatim, en `forense/encargos/2026-09-08-GEN2-SONDA-2-OPERACIONALIZA-SONDA-LATERAL-ENCARGO.md` (ACTO GEN2-SANEA-REGISTRO-Y-RESCATE, cierra NC-0054; sufijo `-ENCARGO` por T02, que colisionaba por nombre normalizado con la nota de ejecución homónima ya viva en `forense/notas/`). Procedencia tipo (3) de v2.1 originalmente: reportado, no verificado; hoy verificado por dirección contra los SHAs declarados. Este expediente ficha el ACTO, no reconstruye el encargo.
