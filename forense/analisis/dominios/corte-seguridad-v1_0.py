...
ROW = dict(
    ...
    dictamen_razon="Microdato, módulo y FD 2025 tienen ids en main y SHA físico coincidente; diseño muestral oficial registrado en #1089, pendiente de merge. La pregunta primaria se verificó, pero el agregado cifra negra requiere reglas por tipo y factor incidentes.",
    ...
    propietario="ASTRA5-U3", siguiente_operacion="Tras merge de #1089 cambiar a MEDIBLE-EN-CORPUS; fijar denominador de incidentes, filtro de delitos, denuncia/carpeta y factor antes de cualquier cálculo.", prioridad="3",
)
