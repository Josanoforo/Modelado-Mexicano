...
**Celda:** `CIV-M-13` — ENVIPE 2024, **delitos de 2023**.
**Releva:** `CORR-0044` → `RES-0118`, el árbitro `R` de esta celda del marco `M`.
Consumidor natural: `forense/prereg-duelo-v2/marco-M-sorteado-v1_3.tsv:CIV-M-13:R`.
...
**Este medidor no lo calcula.** No abre `forense/prereg-duelo-v2/corridas-R/CIV-M-13.json` y no
