...
`NC-0367` abierta y **`FP-393` a mesa**: o se añade `evento` al enum, o se declara que
...
mesa selladas por el lanzamiento). `FP-389` FIRMADA; `FP-393` nueva, ABIERTA. `NC-0355` y
`NC-0356` siguen ABIERTAS —la segunda con enmienda fechada—, `NC-0367` nueva. El par
