...
**Base:** `582d4e9` (merge de `#779`) al abrir → `5973f12` (merge de `#785`) al cerrar. Un merge.
...
| `no_corrido_abiertas` | — | — | −5 +4 (cierra `NC-0193`/`0200`/`0201`/`0204`/`0207`; abre `NC-0211..0214`) |
...
- **Tomó `ADR-514`** sabiendo que `PR #788` (`GEN2-RELEVO-USOS-1`, abierto) también lo redacta en su rama, y `NC-0211..0214` sabiendo que esa rama usa hasta `NC-0217`: renumera quien fusiona segundo.
