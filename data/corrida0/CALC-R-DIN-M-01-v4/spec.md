# `CALC-R-DIN-M-01-v4` — sucesor técnico de replay del árbitro R

 **Corrección adversarial PR #680:** sucede al intento sellado `-v3` sin mutarlo. FP-370 conserva su alcance y no se extiende a este identificador técnico. **Celda:** `DIN-M-01`.
...
Este sucesor técnico no añade una medición: hereda el conteo único de la cadena desde `CALC-R-DIN-M-01-v2`, sin sumar `-v3` ni `-v4`, cuyo objeto firmado es la medición R de `DIN-M-01`.
