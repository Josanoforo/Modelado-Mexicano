...
- **Procedencia.** SHA `6109dae` · fecha del commit `2026-09-21` · ¿árbol == origin/main? `False`.
...
- **Ramas presentes en origin.** **5 rama(s) presente(s) en origin (política de cero)**:
  - `acto/gen2-celda-d-piloto-3-commit-2-3`: 5 delante / 0 detrás de main · último commit `2026-09-20`
  - `acto/gen2-din-credito-pisos-enif2021-1`: 7 delante / 0 detrás de main · último commit `2026-09-20`
  - `acto/gen2-tramite-firmas-3-propagacion`: 3 delante / 45 detrás de main · último commit `2026-09-21`
  - `claude/focused-archimedes-fjyqf5`: 7 delante / 42 detrás de main · último commit `2026-09-21`
  - `claude/new-session-ccjtu7`: 1 delante / 1 detrás de main · último commit `2026-09-21`
...
- **Gobernanza operativa.** ADR máximo `578` · FP máximo `260921` · FP abiertas: FP-386, FP-387, FP-388, FP-393, FP-394, FP-395, FP-396, FP-397, FP-398, FP-403, FP-404, FP-405 · encargos archivados `593` (consumidos `540`) · instrucciones vigentes `v2.15` · cola de encargos (solo estados != CONSUMIDO; consumidos `36`):
...
- **NC abiertas por razón (token A.14, prefijo exacto).** abiertas `176` · por token: `DECISIÓN-DE-MESA-PENDIENTE` 21 · `DIFERIDO-A` 16 · `FUERA-DE-PERÍMETRO` 44 · `NO-VERIFICABLE-AQUÍ` 4 · `PARO-ENTORNO` 4 · `PARO-PREMISA` 18 · `SUSTITUIDO-POR` 1 · prosa (sin token reconocible) `68`.
- **GEN2 (derivado de `corrida0 status`).** corridas selladas `102` / requeridas `86` · resultados sellados `7287` / activos `210` · pendientes `210` · dependencias numéricas legacy activas `149` · validación independiente `215` · diferencias materiales `0` · NC- abiertas `176` · replays LEGACY-GEN1 sellados `5` (no cuentan). El `0 / N` es la lectura correcta: el aparato se construyó antes que las corridas.
