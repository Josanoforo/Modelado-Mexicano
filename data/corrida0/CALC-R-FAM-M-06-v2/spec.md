# `CALC-R-FAM-M-06-v2` — preregistro mecánico del árbitro R

**Acto:** `GEN2-R-COMPLETA-MARCO`, FP-370, 9/sep/2026. **Celda:** `FAM-M-06`.

Congelado antes de abrir microdato. Mide el estimando ya fijado en
`codificacion-R-v1_1.tsv`, sucesora byte-idéntica de v1.0: payload `enigh2018_nc_csv`,
...
`cuenta_gen2 = SI` para este `CALC-R-FAM-M-06-v2`; objeto explícito: la medición R de `FAM-M-06`.
