...
Derivado por auditoría 2026-09-03 (ACTO MAESTRA37-N9 · AUDITA-ENCARGOS-166). `git grep -Fl -- "2026-08-14-RECONCILIA-SPEC-encargo.md"` (excluyendo forense/digesto/) cita nota(s) de cierre: forense/notas/2026-08-14-reconcilia-spec.md, forense/notas/2026-08-17-cierra.md. Encargo pre-ADR-por-archivo (anterior al 18/ago/2026): la evidencia de ejecución vive en la nota de cierre, no en canon/gobernanza-v1_15.md. Marca ausente era defecto de trámite retroactivo, resuelto por esta auditoría.
