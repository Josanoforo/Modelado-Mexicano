# FAMILIA-2027-ENCIG-PAGO-DIGITAL · spec humana condicional v1.0

**Estado: CONDICIONAL, NO LISTA PARA FIRMA DE APERTURA.** El nombre 2027 es un identificador de carpeta, no una fecha publicada. Consultado el calendario INEGI 2026 el 23/sep/2026; fecha oficial de publicación de ENCIG 2027: **NO-CONFIRMADA**. No se abre dato futuro con este borrador.

## Estimando cerrado y piso

- Instrumento/ola objetivo: ENCIG 2027; levantamiento y publicación: NO-CONFIRMADOS. Antes de firmar, mesa coteja cuestionario futuro, FD, pesos, población y periodicidad con la ola 2025.
- Estimando único: pago de luz por canal digital en el universo C de ENCIG MOR. Unidad de observación: **trámite**; escala del punto **proporción [0,1]**. No se agregan otros estimandos tras observar R.
- Piso congelado en este borrador: `RESULT-ENCIG-MOR-C-P-ADOPTA` de `CALC-ENCIG-0001` (ola 2025); SHA-256 de `sello.json`: `9db7e8f292dc4acd43ee1107b00fe7e1c6097d6abaa3b8c78444107b6cbf58d7`. Su valor se lee del RESULT, no se transcribe como parámetro de producto. Si una ola intermedia cambia la identidad, esta spec se declara NO-ELEGIBLE; no se sustituye el piso a posteriori.
...
1. Fecha oficial de publicación de ENCIG 2027 dentro de la ventana 23/sep/2026–23/mar/2028 y texto de cuestionario futuro aún pendientes.
...
Fuente de selección: catálogo U1, commit `0ac21b6c`, contrastado aquí con RESULT y sello del CALC. Comparte apertura de ENCIG 2027 con otras familias de ese instrumento, sin consumir R más de una vez.
