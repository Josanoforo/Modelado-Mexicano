...
Ejecutado por `ACTO GEN2-DUELO-ENVIPE2026-COMMIT-1` · rama `acto/gen2-duelo-envipe2026-commit-1` · **PR #968** (21/sep/2026) · ADR `ADR-260921-GEN2-DUELO-ENVIPE2026-COMMIT-1-8796-01` · nota `forense/notas/2026-09-21-GEN2-DUELO-ENVIPE2026-COMMIT-1-nota.md`. Tres CALC sellados (`CALC-DUELO-ORIGEN-MOVIL-0001`, `CALC-DUELO-ENSAYO-ENVIPE2025-EMISIONES-0001`, `CALC-DUELO-ENSAYO-ENVIPE2025-ADJUDICACION-0001`); los dos de 2026 quedan `SPEC-FIJADA` sin congelar (NC `…-8796-01`). ENVIPE 2026 no se abrió ni se descargó.
