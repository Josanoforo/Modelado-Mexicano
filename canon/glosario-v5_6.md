...
- **El motor no tiene entidad prestamista** — frontera declarada de **ADR-35**. El hallazgo *"el riesgo vive en el fondeo del prestamista, no en el deudor"* no puede representarse; su refutación (`ref.A.04`) sigue **sin objeto**. Nuevo en v5.5. *(19/ago/2026: enmienda a ADR-35 redactada y no ejecutada — `forense/notas/2026-08-19-adr35-enmienda-borrador.md`, `FP-61`. Las otras siete refutaciones sin objeto de la misma batería ya ganaron variable declarada, `ADR-115`, `modelo §1.1.G`.)*
