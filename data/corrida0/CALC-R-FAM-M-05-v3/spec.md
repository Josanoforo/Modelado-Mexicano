# `CALC-R-FAM-M-05-v3` — sucesor técnico de replay del árbitro R

 **Corrección adversarial PR #680:** sucede al sello `-v2` sin mutarlo. FP-370 conserva su alcance y no se extiende a este identificador técnico. **Celda:** `FAM-M-05`.
...
`codificacion-R-v1_2.tsv`, sucesora registral de v1.1 que conserva el estimando y explicita reservas: payload `enigh2016_nc_csv`,
...
Este sucesor técnico no añade una medición: hereda el conteo único de la cadena desde `CALC-R-FAM-M-05-v2`, cuyo objeto firmado es la medición R de `FAM-M-05`.
