# ENCARGO · ACTO ASTRA6-C3-SOCIAL-1 · reports v2 completos de confianza, capital social y religiosidad
...
Reescribir íntegramente 3 reports del corpus en v2 contra la evidencia disponible, con tesis revisadas, tabla exhaustiva de afirmaciones y reglas propuestas. No entregar solo esquema o inventario. Alcance cerrado de este lote:

- `corpus/reports/Confianza_y_Desconfianza_en_México__Anatomía_Psicológica_de_una_Sociedad_Dual.md` → `corpus/reports-v2/Confianza_y_Desconfianza_en_México__Anatomía_Psicológica_de_una_Sociedad_Dual.md`.
- `corpus/reports/Non-Family_Social_Capital_in_Mexico__Cooperation__Trust__and_Collective_Action_Beyond_Kinship.md` → `corpus/reports-v2/Non-Family_Social_Capital_in_Mexico__Cooperation__Trust__and_Collective_Action_Beyond_Kinship.md`.
- `corpus/reports/Religiosidad_y_Psicología_del_Mexicano_Contemporáneo__Moral__Afrontamiento__Consumo_e_Identidad_en_Transformación.md` → `corpus/reports-v2/Religiosidad_y_Psicología_del_Mexicano_Contemporáneo__Moral__Afrontamiento__Consumo_e_Identidad_en_Transformación.md`.

«Hecho»: `python3 forense/analisis/reports-v2/social-1/verifica_lote.py` (verificador local propio a entregar) confirma cobertura de afirmaciones y trazabilidad de cifras propias/externas, referencias válidas y separación de estados; revisión sustantiva dirigida verifica que las citas sostienen tesis y denominadores. Entregar los 3 reports completos y su índice local; cero afirmaciones materiales del universo del lote omitidas en silencio.
...
[EJECUTADO] Árbol del corte: 31 archivos .md bajo corpus/reports; los 3 nombres de §1 existen. [EXISTE] Los archivos de este lote se localizaron por nombre; esta preparación no leyó íntegros los reports v1. La sesión debe hacerlo antes de reescribir.
...
Priorizar tres contrastes de tesis: confianza generalizada frente a confianza familiar/comunitaria; participación comunitaria frente a asociacionismo formal; afiliación religiosa frente a importancia y práctica. Reconstruir cada conclusión desde RESULT y cuestionario, sin heredar el veredicto de la nota como verdad automática. Diferencias entre casas encuestadoras y años no identifican efecto de casa ni cambio temporal por separado. No atribuir mecanismos a gradientes descriptivos.

Puntos de entrada: `forense/notas/2026-09-25-GEN2-CONFIANZA-RELIGIOSIDAD-CAPITAL-SOCIAL-PISOS-1-cierre.md`, catálogo vigente y CALC WVS/LATINOBAROMETRO/PEW/LAPOP. Confirmar adopciones y reservas al corte. No se abren olas reservadas para completar comparaciones.
...
Propio: únicamente los reports-v2 enumerados en §1; `forense/analisis/reports-v2/social-1/` con tabla, índice local, comprobador, hoja y recibo; notas y cascada propia. No alterar otros reports v2 en vuelo.
