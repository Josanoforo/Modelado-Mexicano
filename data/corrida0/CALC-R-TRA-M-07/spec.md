# `CALC-R-TRA-M-07` — preregistro mecánico del árbitro R

**Acto:** `GEN2-R-COMPLETA-MARCO`, FP-370, 9/sep/2026. **Celda:** `TRA-M-07`.

Congelado antes de abrir microdato. Mide el estimando ya fijado en
`codificacion-R-v1_1.tsv`, sucesora byte-idéntica de v1.0: payload `encig2021_csv`,
...
`cuenta_gen2 = SI` para este `CALC-R-TRA-M-07`; objeto explícito: la medición R de `TRA-M-07`.
