# CALC-ENADID2023-UNION-SEXO-EDAD-0003
...
`forense/prereg-caja/ENADID2023-UNION-SEXO-EDAD-spec-v1_2.md`. Esta operación conoce el resultado del padre
...
Este CALC sucede a 0002, que permanece sellado. Corrige sólo la semántica de
conteos en las filas `peso_estandar_edad`: `n_numerador` es el conteo del
tramo y `n_denominador` el conteo conjunto de los cinco tramos. No cambia
universo, masas, pesos, puntos, réplicas, incertidumbre ni estandarización.
