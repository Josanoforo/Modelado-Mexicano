...
Ejecutado por `PR #932` (rama `acto/gen2-din-credito-comparabilidad-texto-1`, 20/sep/2026, CAJA, Opus). `ADR-572`, `NC-0433`–`NC-0435`, `FP-404`. Entregable: `data/credito-comparabilidad-texto-v1_0.tsv` + `.meta`, `tests/test_credito_comparabilidad_texto.py`, `forense/notas/2026-09-20-GEN2-DIN-CREDITO-COMPARABILIDAD-TEXTO-1-cierre.md`. Merge de mesa pendiente.
