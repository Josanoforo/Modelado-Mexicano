...
**Corrección post-cierre (mismo día):** el encargo llegó primero como texto de conversación, sin archivo en el árbol — el triaje de arriba se ejecutó contra ese texto. El archivo `forense/encargos/2026-08-24-TRIAGE-UNIVERSO-12.md` llegó después y se commiteó retroactivamente, marcado `CONSUMIDO`, sin abrir de nuevo el triaje ya cerrado. Verificación adicional en ese cierre: **194** menciones case-insensitive de `ennvih|mxfls` en el manifiesto (no 137 — ese era solo el conteo en minúscula estricta; dirección reportó el número correcto), coincide con la cifra de dirección. `data/curacion-universo/` (36 archivos) examinado íntegro: ninguno referente a las 12 reglas — son artefactos de `BARRIDO-2`, dominio distinto, no aporta ruta nueva a este triaje.
