...
**Acto:** `DUELO-PREREG-V2` (nube, Opus; gate `T-SELLO` + `ACT-PIL-2` fusionados). Nombre estable de este mecanismo: **`ADV1-M5`** — nunca "M5" a secas (colisiona con `M5` del `ADR-MOTOR-2-esqueleto`, mecanismo distinto).

**Fuente:** copiado VERBATIM de `forense/CAREO-ADV-DUELO-diseno-v2-2026-08-19.md` §B, párrafo `M5` (única definición de la escala en el corpus). Sin edición de cuerpo — cualquier palabra fuera del bloque en cursiva de abajo es aparato de este acto, no del careo.
...
## Texto verbatim — `ADV1-M5` (`CAREO-ADV-DUELO-diseno-v2-2026-08-19.md` §B, párrafo `M5`)
