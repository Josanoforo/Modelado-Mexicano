...
| ENVIPE | `cumple_norma_envipe2025` | 32 entidades | Pendiente | Complemento con RESULT y denominador propios. |
...
| ENIF | `no_tiene_ahorros_enif2024` | seis regiones oficiales | Pendiente | Complemento requiere RESULT regional propio. |
| ENIF | `informal_cualquiera` | seis regiones oficiales | Medida, 2018/21/24, dominio 18–70 | — |
| ENIF | `ahorra_solo_informal`, `ahorra_solo_formal`, `ahorra_ambas_vias`, `formal_cualquiera` | seis regiones oficiales | Pendiente | Baterías y universos independientes. |
...
La fracción **medida dentro de cada serie corrida** se deriva del canon: todas las filas esperadas de sus tres pisos iniciales y ocho olas históricas están presentes, incluidas las que R2 pudiera suprimir. Esta fracción no es cobertura del catálogo general. En el lote actual, `python3 tools/astra/region/publica.py` declara 248 filas y estados; los denominadores de conductas pendientes no se convierten en ceros.
