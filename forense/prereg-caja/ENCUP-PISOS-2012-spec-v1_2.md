# CALC-ENCUP-PISOS-2012-0003 · Interés, eficacia y confianza

El primer resultado que produzca este procedimiento es el que se reporta.
Sucesor explícito de `CALC-ENCUP-PISOS-2012-0002`: éste se selló con dos
reactivos NO-ESTIMABLE porque el XLSX trae las etiquetas literales `Mucho`,
`Poco`, `Nada` en P37/P51_2, no sus códigos impresos en el cuestionario.
La inspección posterior mostró exactamente esos tres valores sustantivos y
`No sé`/`No contesta`. Este CALC vuelve al microdato crudo con el mapa fijo
`Mucho→1`, `Poco→2`, `Nada→3`; P30 conserva su escala numérica original.
El predecesor `CALC-ENCUP-PISOS-2012-0001` falló sin
