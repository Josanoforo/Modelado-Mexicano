...
def medir(inputs,contrato):
    ...
    out.update({"RESULT-PISOS-ENCIG2023-V2-FILAS-EVENTOS":int(len(events)),
      "RESULT-PISOS-ENCIG2023-V2-JOIN-SIN-DEMOGRAFIA":int(joined["_merge"].ne("both").sum()),
      "RESULT-PISOS-ENCIG2023-V2-DIGITAL-N-UNIVERSO":int(universe.sum()),
      "RESULT-PISOS-ENCIG2023-V2-P7-3-EXCLUIDAS":
        int((ntra.eq("1")&~p73.isin(["1","2","4","5","6"])).sum())})
    return out
