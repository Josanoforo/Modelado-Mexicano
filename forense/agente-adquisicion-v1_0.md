...
> | **Comprobación y presupuesto** | La misma tarea comprueba determinísticamente cada hora y al iniciar sesión; el launcher sólo entrega al runner si hay trabajo o recuperación diaria. Techo agregado diario: 3 necesidades, 5 objetos y 3,900 s, reservado antes del único hijo. | Una llamada a modelo, PR o descarga por cada comprobación y topes independientes por activación. |
>
