...
Cerrado por `ACTO GEN2-ENUT-NUCLEO-CELDAS-1` en **PR #1007** (`acto/gen2-enut-nucleo-celdas-1`, 0-bis `9f24df72`, cascada `c9ac7436`), 22/sep/2026, CAJA, por **PARO-PREMISA** en el ARRANQUE: cero mediciones, cero CALC. Adenda de mesa: `2026-09-22-GEN2-ENUT-NUCLEO-CELDAS-1-ADENDA-1.md`. Firma de mesa (a)(b′)(c) asentada: `FP-260921-GEN2-ENUT-PISOS-Y-SERIE-1-308c-01` → FIRMADA, con enmienda «21 → 12 filas». Sucesor escrito: `GEN2-ENUT-ENLACE-MARCADOR-1`. `ADR-260922-GEN2-ENUT-NUCLEO-CELDAS-1-9f24-01`; `NC-260922-GEN2-ENUT-NUCLEO-CELDAS-1-9f24-01..03`. Mesa fusiona.
