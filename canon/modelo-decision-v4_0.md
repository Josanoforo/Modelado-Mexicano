...
| 13 | **Siete variables nuevas declaradas** (esfuerzo/horas, salud mental, emprendimiento, canal de compra, colorismo, religiosidad, ítem actitudinal de deferencia a la autoridad) — dan objeto a siete de las ocho refutaciones sin objeto; ninguna calibrada. Octava (`prestamista`) queda **sin objeto, bloqueada** por la frontera de ADR-35 | 114 | Atributos/dominio |
...
#### 1.1.G · Ocho variables nuevas, para darles objeto a las refutaciones sin objeto *(ADR-116, ejecuta `FP-56`/`ADR-110(a)`/`ADR-111(c)`)*
