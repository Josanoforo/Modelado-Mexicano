...
ROW = dict(
    ...
    gen2_existente="#1085 MAIN 579462b33914c91094b66637233063583331e825: RESULT-ENDUTIH-PISOS-2024-TABLA / CALC-ENDUTIH-PISOS-2024-0001 / resultados SHA 4c0a3b05b6ecef3e9d7e760163cc6a6691ceaf384fa522e620bbe9b663088c25; cotejo por reactivo en cotejo-result-endutih-v1_0.tsv.",
    propietario="ASTRA5-U4",
    siguiente_operacion="Conservar cotejo 2024 de P7_1 y P7_2 categorías 1/3/4; obtener resultado P7_2=2 con mismo diseño antes de comparar 9.5%; no inferir alfabetización causal.",
    prioridad="2",
)
