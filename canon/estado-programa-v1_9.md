...
| **`gobernanza`** | `gobernanza-v1.15.md` | 57 ADR, protocolo de cambio |
...
**Paso 2 — EN CURSO. 8 de 27 corridas.** *(Corregido 4/ago/2026, Encargo Y — propaga `R4.2` → `D`, ADR-55. Corregido de nuevo 4/ago/2026, Encargo Z — propaga `R4.1`/`R9.1`/`R4.3`(A,B)/`R9.2` → `D`, ADR-56.)*
