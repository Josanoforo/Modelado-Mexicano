...
- **B descartada:** la reducción no es ambigua (es consistentemente ausente o de signo contrario en las seis olas y en cada estrato de ingreso, §5 y §7) ni el monto es insuficiente (60-63% del gasto per cápita post-reforma, §6).
...
**Fila propuesta: A.** *"<10% de reducción con monto suficiente documentado"* — literalmente sobre-satisfecha: la reducción medida es ≤0 (nula o negativa, es decir, un aumento) en las seis olas y en cada estrato de ingreso post-reforma, y el monto está documentado como sustancial (60-63% del gasto per cápita). **Bajo esta prueba, la regla se refuta en el nivel donde se usa: la familia no retrocede cuando el Estado entra — si acaso, beneficiario y familia se mueven juntos, no en sustitución.**
