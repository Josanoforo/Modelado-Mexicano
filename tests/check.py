...
def t02_duplicates():
    ...
    EXCEPTED_NAME_GROUPS = (
        ...
        # specs selladas (v1.0 ENIGH, v1.1 ENIGH, v1.0 ENGASTO); contenido distinto al de salud-bienestar.
        frozenset({
...
_T25_ARCHIVOS_CONOCIDOS = {
    ...
    # pieza) son la misma clase de cita. Misma cita en el ADR/L0 y en el
    # `## NO-CORRIDO / RESERVAS` del encargo archivado (cuerpo sellado,
    # nunca editado; sólo la sección de cierre, añadida después del 0-bis).
...
#   `canon/estado-programa-v1_16.md` creció de 797 824 caracteres a
...
#   `canon/estado-programa-v1_16.md` que los actos venían apendicando no
