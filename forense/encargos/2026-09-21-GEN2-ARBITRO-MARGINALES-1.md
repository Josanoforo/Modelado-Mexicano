...
PR #971 (`acto/gen2-arbitro-marginales-1`), 21/sep/2026, CAJA. ADR `ADR-260921-GEN2-ARBITRO-MARGINALES-1-ed7d-01`; nota `forense/notas/2026-09-21-GEN2-ARBITRO-MARGINALES-1-cierre.md`. Cuatro corridas selladas (`CALC-ARBITRO-MARGINALES-{ENIF2024,ENVIPE2025,ENCIG2025}-0001`, `CALC-ARBITRO-PERSISTENCIA-ERROR-0001`), `cuenta_gen2 = SI` ×4, no adopta; marcador 57 `SOLO-PISO` → 57 `EVALUADA`; `celdas_validadas` 73 → 77. Mesa fusiona.
