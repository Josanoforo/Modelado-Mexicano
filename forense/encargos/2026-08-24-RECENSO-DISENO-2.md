...
- **Estado:** `CONSUMIDO` — ejecutado el 24/ago/2026 (`ADR-153`, fusionado como `PR #321`, `3bae09f`), nota `forense/notas/2026-08-24-recenso-diseno-2.md`. Archivado retroactivamente el 25/ago/2026 por `ACTO BANDAS-DOC-6` — el texto no se había commiteado al árbol pese a haberse ejecutado y fusionado (incumplimiento de `forense/encargos/convencion.md` detectado por ese acto; texto recuperado y archivado aquí, verbatim, sin editar).
