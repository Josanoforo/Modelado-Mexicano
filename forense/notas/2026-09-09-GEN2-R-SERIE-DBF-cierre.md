...
## Enmienda fechada (14/sep/2026, `ACTO GEN2-VERIFICACION-CAJA-2`) — la reserva `NC-0100` queda saldada

El texto de arriba y la fila `NC-0100` del encargo archivado (`forense/encargos/2026-09-09-GEN2-R-SERIE-DBF.md`, «no repara el inventario de reactivos para DBF (si su hueco molesta a futuro, es fila `NC` con sucesor)») **no se editan**. Lo que esta enmienda añade: el hueco se reparó en dos tandas. `ACTO GEN2-39` (PR #742) acreditó 1 272 de las 1 304 filas DBF del trío (2012 400/400, 2013 410/419, 2015 462/485). `ACTO GEN2-VERIFICACION-CAJA-2` acreditó las **32 restantes una por una contra el descriptor oficial de cada ola** (`fd_envipe2013.xlsx` `7e842826e3f7…`, `fd_envipe2015.pdf` `1042ab57b015…`): **7 `ACREDITADA`, 18 `ACREDITADA-CON-NOTA`, 7 `NO-LOCALIZADA-EN-DESCRIPTOR-OFICIAL`** — las cinco `AP5_*` de 2015 (el PDF oficial salta de `AP5_6_01` a `AP5_7_2` entre pp. 26 y 27) y las dos `EST_SOC` de 2013 (el FD documenta `EST`, no `EST_SOC`). Tabla completa y citas en `forense/notas/2026-09-14-GEN2-VERIFICACION-CAJA-2-cierre.md` §2. `NC-0100` pasa a **CERRADA** con ese saldo; el texto oficial de las siete no localizadas queda para la vía de titular (`NC-0185`), no para el corpus. Ninguna cifra de la serie DBF cambia: el trío viejo nunca dependió del inventario, como ya decía la fila.
