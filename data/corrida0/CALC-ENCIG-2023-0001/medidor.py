"""`CALC-ENCIG-2023-0001` -- mordida por canal (familia B de `CALC-ENCIG-0001`)
...
se edita. Spec humana sellada: `forense/prereg-caja/ENCIG-MORDIDA-2023-spec-v1_0.md`
...
Lo que decide el CODIGO y no la spec, declarado para que se pueda refutar:
  ...
  · CODIGO FUERA DE MAPA: se juzga sobre el soporte de la columna ENTERA
    ...
    numerico distinto de blanco/'b' tambien es fuera de mapa.
