...
def enumerar_universo() -> list[Path]:
    """Payloads bajo data/raw, excluyendo el bucle de symlink data/raw/raw."""
    vistos: set[Path] = set()
    resultado: list[Path] = []
...
def procesar(path: Path) -> tuple[list[dict], str]:
