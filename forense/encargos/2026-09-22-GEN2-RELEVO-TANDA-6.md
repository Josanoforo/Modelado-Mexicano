...
PR #985. Ejecutado por esta sesión en la rama `acto/gen2-relevo-tanda-6`. P1 completo (asiento de replay ya existía; registro derivado puesto al día en árbol de trabajo, no commiteado por ser DERIVADO; `NC-260922-GEN2-RELEVO-TANDA-5-f54e-01` CERRADA). P2 PARA (ver `## NO-CORRIDO`). P3 completo (FP F-L actualizada, sigue FIRMADA; nota de cierre `forense/notas/nota-2026-09-22-gen2-relevo-tanda-6-cierre.md`; `ADR-260922-GEN2-RELEVO-TANDA-6-7510-01`).
