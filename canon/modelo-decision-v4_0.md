...
| **49 reglas · 27 de perímetro · 12 de 27 corridas · 20 `[FUERTE]`** | 49/27/20 sin cambio respecto del v3.4, recuento mecánico sobre §3.B, reproducible con `python3 tests/validador_registro_ids.py`; corridas 2→3 por `R7.2` → `D`, archivado 4/ago/2026 (ADR-45); 3→4 por `R4.2` → `D`, archivado 4/ago/2026 (ADR-55, Encargo Y); 4→8 por `R4.1`/`R9.1`/`R4.3`(A,B)/`R9.2` → `D`, archivados 4/ago/2026 (ADR-56, Encargo Z); 8→11 por `R5.1`/`R5.2` → `A` y `R1.2` → `E`, archivados 4/ago/2026 (ADR-58); 11→12 por `R3.1` → `B`, archivado 4/ago/2026 (ADR-60) — tier `[FUERTE]` de `R3.1` sin tocar, 20 `[FUERTE]` sin cambio | **Heredado, con receta ejecutable — corridas actualizado 4/ago/2026** |
