"""Perfil estructural de personas ENIGH 2020, conforme a spec v1.0.
...
en la ola 2020, poblacion.csv NO trae factor/est_dis/upm (verificado por columna
contra el header real del zip: 2020 vs 2022) -- se toman de concentradohogar por
...
ZIP_ID = "enigh2020_nc_csv"
P = "RESULT-ENIGH20-PERFIL-"
MIEMBROS = {
    "poblacion": "conjunto_de_datos_poblacion_enigh_2020_ns/conjunto_de_datos/conjunto_de_datos_poblacion_enigh_2020_ns.csv",
    "concentrado": "conjunto_de_datos_concentradohogar_enigh_2020_ns/conjunto_de_datos/conjunto_de_datos_concentradohogar_enigh_2020_ns.csv",
    "hogares": "conjunto_de_datos_hogares_enigh_2020_ns/conjunto_de_datos/conjunto_de_datos_hogares_enigh_2020_ns.csv",
}
COLUMNAS = {
...
FUENTES = {
    "segsoc": "Codificación heredada de ENIGH 2022 Descripción de la base p. 75 (1=Sí, 2=No); 2020 no tiene descriptor propio en el corpus, no verificado independientemente contra su codebook -- ASUME continuidad de nueva serie 2016-2022 (ADR de corte de serie de este acto)",
    "tramo_edad": "Tramos operativos propios de este medidor (18-96), no de INEGI; corte igual en todas las olas",
    "tam_loc": "Codificación heredada de ENIGH 2022 Descripción de la base pp. 45 y 186 (1..4); 2020 no tiene descriptor propio en el corpus, no verificado independientemente",
    "est_socio": "Codificación heredada de ENIGH 2022 Descripción de la base pp. 46 y 186 (1..4); 2020 no tiene descriptor propio en el corpus, no verificado independientemente",
    "conex_inte": "Codificación heredada de ENIGH 2022 Descripción de la base p. 54 (1=Sí, 2=No); 2020 no tiene descriptor propio en el corpus, no verificado independientemente",
    "celular": "Codificación heredada de ENIGH 2022 Descripción de la base p. 54 (1=Sí, 2=No); 2020 no tiene descriptor propio en el corpus, no verificado independientemente",
}
...
def medir(inputs, contrato):
    ...
    return {
        ...
        P + "P3-EVIDENCIA": "ENIGH2022-DESCRIPCION-BASE-PP75:5-ANOS-VS-OCTUBRE-2005;UNIVERSO-Y-SALTOS-NO-ACREDITADOS;OLA-2020-SIN-DESCRIPTOR-PROPIO-EN-CORPUS-NO-VERIFICABLE",
        P + "EMBUDO-JSON": emb,
