...
- **Procedencia.** SHA `4075e697` · fecha del commit `2026-09-22` · ¿árbol == origin/main? `False`.
...
- **Ramas presentes en origin.** **6 rama(s) presente(s) en origin (política de cero)**:
  - `acto/gen2-din-credito-escolaridad-2`: 13 delante / 30 detrás de main · último commit `2026-09-22`
  - `acto/gen2-din-lote-c2-restringido-1`: 13 delante / 36 detrás de main · último commit `2026-09-22`
  - `acto/gen2-enut-nucleo-celdas-1`: 6 delante / 36 detrás de main · último commit `2026-09-22`
  - `claude/festive-hypatia-cerq3p`: 1 delante / 0 detrás de main · último commit `2026-09-22`
  - `claude/gen2-enif-persistencia-ic-calibrado-1`: 8 delante / 36 detrás de main · último commit `2026-09-22`
  - `claude/gen2-marginales-adopcion-1`: 14 delante / 36 detrás de main · último commit `2026-09-22`
...
- **Gobernanza operativa.** ADR máximo del espacio numérico CERRADO `593` · FP máximo del mismo espacio `409` · ids con raíz de acto (época vigente) `{'ADR': 42, 'FP': 57, 'NC': 129}` · FP abiertas: FP-260921-GEN2-ENUT-PISOS-Y-SERIE-1-308c-01, FP-260921-GEN2-CORPUS-INTEGRIDAD-Y-RESPALDO-1-3d56-01, FP-260921-GEN2-DIN-CREDITO-HISTORIA-1-ff56-02, FP-260921-GEN2-ARBITRO-MARGINALES-1-ed7d-02, FP-260921-GEN2-DIN-LOTE-ENIF2024-COMMIT-2-3-8e53-02, FP-260922-GEN2-MARCO-M-CONSUMIDOR-1-02e6-01 · encargos archivados `659` (consumidos `599`) · instrucciones vigentes `v2.16` · cola de encargos (solo estados != CONSUMIDO; consumidos `36`):
...
- **NC abiertas por razón (token A.14, prefijo exacto).** abiertas `204` · por token: `DECISIÓN-DE-MESA-PENDIENTE` 22 · `DIFERIDO-A` 33 · `FUERA-DE-PERÍMETRO` 43 · `NO-VERIFICABLE-AQUÍ` 6 · `PARO-ENTORNO` 1 · `PARO-PREMISA` 17 · `SUSTITUIDO-POR` 3 · prosa (sin token reconocible) `79`.
- **GEN2 (derivado de `corrida0 status`).** corridas selladas `157` / requeridas `87` · resultados sellados `47648` / activos `211` · pendientes `211` · dependencias numéricas legacy activas `146` · validación independiente `215` · diferencias materiales `0` · NC- abiertas `204` · replays LEGACY-GEN1 sellados `5` (no cuentan). El `0 / N` es la lectura correcta: el aparato se construyó antes que las corridas.
