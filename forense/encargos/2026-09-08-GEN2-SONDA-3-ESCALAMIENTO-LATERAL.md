...
**P4 · Depuración de los Deep Research.** Los seis supuestos que NO se incorporan quedan en `sonda.md` como sección de advertencias: SODA3/SODA2.1, 403≠ASN, SHA256 vs CDX digest, DuckDB remoto, source maps, tabulados≠microdatos — con la línea de cierre: los estudios son repertorio, las capacidades se confirman al usarse.
