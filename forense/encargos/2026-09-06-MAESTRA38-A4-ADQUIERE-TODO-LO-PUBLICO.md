...
**Cascada**: `ADR-348` (`canon/gobernanza-v1_15.md` §4; candidato derivado contra `346`, contiguo → `347`, cedido a `ACTO MAESTRA38-N15` al fusionar `PR #550` primero — regla de la casa, renumera quien fusiona segundo; cabecera `347` → `348 ADR`), `L0` recifrado con la anotación nueva **insertada antes de la anterior** (`canon/estado-programa-v1_12.md`, más su cabecera de conteo), `canon/registro-rotulos.tsv` censa `MAESTRA38-A4`, `forense/firmas-pendientes.tsv` `FP-313` (recibo) y `FP-314` (firma de mesa sobre las recetas, vence 13/sep/2026), `forense/hallazgos.md` +6 entradas, `forense/tablero/TABLERO-PROGRAMA-v1_1.md` §8.14, `data/INFRAESTRUCTURA-v1_0.md` +4 líneas.
