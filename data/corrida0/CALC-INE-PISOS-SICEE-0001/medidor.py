...
Gobernado por forense/prereg-caja/INE-SICEE-PARTICIPACION-spec-v1_0.md.
...
def filas_medidas(registros, cargos):
    ...
    for r in registros:
        ...
        tv = numero(r["total_votos"], True)
        ln = numero(r["lista_nominal"], True)
        pub = numero(r["porcentaje_participacion"], False)
