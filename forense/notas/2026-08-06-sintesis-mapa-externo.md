...
fuentes o búsquedas únicas antes del filtro material. El mapa final conserva 41
filas: 15 A, 10 B, 10 D y 6 C. Las otras 30 fuentes únicas se excluyeron por no
...
- IECM, CSES, el experimento electoral de 2009, Votar entre Balas e INE tienen
  diseños y unidades electorales diferentes;
...
- **B (10):** fuentes materiales pero subordinadas a las A o sin encaje
...
fintech; UCDP no cubre protesta general; y no apareció denuncia enlazada con
tenencia de seguro. Estas conclusiones acotan el universo declarado, no todo
México.
