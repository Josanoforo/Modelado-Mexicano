# ENOE pisos trimestrales · spec v1.0

**El primer resultado que produzca este procedimiento es el que se reporta.**
Acto ASTRA5-U1-TRABAJO-ENOE, `CALC-ENOE-PISOS-0001`. RETROSPECTIVA.
...
`tools/dominios/enoe/pisos.py`, importado por shim con hash verificado antes
