...
CALC_ID = "CALC-ENADID2023-UNION-SEXO-EDAD-0001"
...
def medir(inputs: dict, contrato: dict) -> dict:
    ...
    return {
        "RESULT-ENADID-USE-P1-TABLA-SHA256": _sha(outputs["distribucion.csv"]),
        "RESULT-ENADID-USE-P2-TABLA-SHA256": _sha(outputs["union_condicional.csv"]),
        "RESULT-ENADID-USE-P3-TABLA-SHA256": _sha(outputs["estandarizacion.csv"]),
        "RESULT-ENADID-USE-FLUJO-SHA256": _sha(outputs["flujo.csv"]),
        "RESULT-ENADID-USE-AUDITORIA-SHA256": _sha(outputs["auditoria.json"]),
        "RESULT-ENADID-USE-DIF-BRUTA-MH": std["diferencia_bruta"]["punto"],
        "RESULT-ENADID-USE-DIF-ESTANDAR-MH": std["diferencia_estandarizada"]["punto"],
        "RESULT-ENADID-USE-BRUTA-MENOS-ESTANDAR": std["bruta_menos_estandarizada"]["punto"],
        "RESULT-ENADID-USE-REPLICAS": REPLICATES,
        "RESULT-ENADID-USE-SEMILLA": SEED,
        "RESULT-ENADID-USE-SALIDA": "forense/analisis/enadid2023-union-sexo-edad-cli-2",
    }
