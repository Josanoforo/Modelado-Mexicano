...
públicos y las ocho olas ENVIPE que E08 necesita están presentes. No se vuelven
...
| F5 | cobertura documental de las 14 celdas del lote 01 | paquete F5 v1.0, 37 documentos | existe, pero el ensamblado anterior truncó las celdas críticas | es defecto de selección/ensamblado, no de acceso. F5 debe fijar primero el hueco por celda; sólo entonces E09 adquiere un objeto exacto |
| corrupción general | D08 / lote 02 | ENCUCI 2020 `AP5_17/AP5_18`, `CALC-R-TRA-M-02-v3`; UNAM-IIJ corrupción | ENCUCI da `0.1260` entre personas con contacto; UNAM cubre cuatro trámites | falta adjudicar el denominador general. ENCIG `B-COVERAGE=0.200895` es condicional entre declarantes; no abrir otra búsqueda hasta que E04 inscriba la demanda exacta |
| ENVIPE serie | E08 / `NC-0087/0093/0101` | ocho olas pendientes, 2011/2014/2016–2020/2022 | todos los payloads están presentes y coinciden con manifiesto | falta medición y comparabilidad, no adquisición; E08 produce specs y serie |
...
residuales sustantivos sobreviven en `NC-0151` (accesos) y `NC-0037` (ruta
académica/pública de tandas), no en una repetición de las 28 filas. `FP-314`
