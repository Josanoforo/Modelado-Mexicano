...
Derivación mecánica (`/tramite`, §3.3): único `Merge pull request #N` cuyo mensaje cita el rótulo `EVAL-COMPARTAMOS-LLAVE3` — `PR #331` (`7848b97`), y ese merge toca este archivo además de otros 6 (`git diff --stat 7848b97^1 7848b97`).
