...
def measure_rows(rows, replicas=2000, seed=20260919):
    ...
    return {
        "RESULT-ENCUCI2020-RPC-N-FILAS": len(rows),
        "RESULT-ENCUCI2020-RPC-N-PONDERADOR-VALIDO": n,
        "RESULT-ENCUCI2020-RPC-MASA-PONDERADA": float(survey.w.sum()),
        "RESULT-ENCUCI2020-RPC-LLAVE-IDPER": "UNICA" if len(ids) == len(set(ids)) else "NO-UNICA",
        "RESULT-ENCUCI2020-RPC-N-ESTRATOS": survey.n_strata,
        "RESULT-ENCUCI2020-RPC-N-UPM": survey.n_psu,
        "RESULT-ENCUCI2020-RPC-N-ESTRATOS-SINGLETON": survey.n_singleton,
        "RESULT-ENCUCI2020-RPC-METODO-IC": method,
        "RESULT-ENCUCI2020-RPC-PERFIL-POR-CONTACTO": _json(by_contact),
        "RESULT-ENCUCI2020-RPC-CONTRASTES-POR-CONTACTO": _json(contrasts),
        "RESULT-ENCUCI2020-RPC-SOLAPAMIENTO-OTROS-CONTACTOS": _json(solapamiento),
        "RESULT-ENCUCI2020-RPC-VALIDACION-PARTICION": None if partition is None else partition - 1.0,
        "RESULT-ENCUCI2020-RPC-VALIDACION-UNION": union_identity,
    }
