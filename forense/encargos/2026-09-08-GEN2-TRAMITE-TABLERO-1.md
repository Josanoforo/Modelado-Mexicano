...
Ejecutado por `PR #633` (`claude/happy-davinci-i61zay` → `main`), 8/sep/2026. Siete piezas (A1-A7) corridas íntegras contra `origin/main = d48014ed`; cascada cerrada (`ADR-411`, `canon/estado-programa-v1_12.md` L0/tabla, `canon/registro-rotulos.tsv`, `tests/check.py --baseline` VERDE). `## NO-CORRIDO / RESERVAS`: Ninguno.
