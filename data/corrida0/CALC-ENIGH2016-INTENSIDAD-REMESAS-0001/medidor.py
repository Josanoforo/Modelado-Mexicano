"""Monto e intensidad contable de remesas entre hogares receptores, ENIGH 2016.
...
padre usa el valor ya sellado de la ola 2016 en CALC-B-0001/resultados.json
...
P = "RESULT-ENIGH16-REMINT-"
MIEMBRO = (
    "conjunto_de_datos_concentradohogar_enigh_2016_ns/conjunto_de_datos/conjunto_de_datos_concentradohogar_enigh_2016_ns.csv"
)
COLUMNAS = [
