...
**Contadores antes/después:** CALC regionales sellados `0 → 14`; filas del canon regional `0 → 514`; comparaciones retrospectivas en mapa `0 → 204`. Comandos: `python3 tools/astra/region/publica.py` y `python3 tools/astra/region/mapa.py` sobre el HEAD del PR [#1072](https://github.com/Josanoforo/Modelado-Mexicano/pull/1072). Es un **avance con reservas materiales**, no cierre integral ni adopción.
