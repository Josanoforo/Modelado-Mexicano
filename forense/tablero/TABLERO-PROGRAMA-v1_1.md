**(8/sep/2026 — ACTO GEN2-TRAMITE-TABLERO-1, A6.) `forense/tablero/TABLERO-PROGRAMA.md` ya NO lleva este mismo contenido**: A1 de ese acto lo reemplazó por el cuerpo reconstruido para Gen 2. La nota de abajo (7/sep/2026, MAESTRA38-TRAMITE-3) sigue siendo el registro correcto de cuándo y por qué este archivo quedó superado; solo su afirmación de que ambos archivos "llevan este mismo contenido" describe el árbol de entonces, no el de hoy. Este archivo es historia de la capa curada v1.1 (snapshot `9cbd8d8`, 2/sep/2026); no se edita más allá de anotarlo — append-only.
